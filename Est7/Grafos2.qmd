...
#| warning: false
library(ggplot2)
df_moteles <- read.csv("Moteles_Final.csv")
...
![Histograma grado de los moteles](GradoMoteles.jpg)

![Mapa clasificado por grado de los moteles](MapaGrafoMoteles.jpg)
...
El diámetro de la componente gigante es 8, es decir, el par de moteles más distante requiere ocho pasos para conectarse a través de la red. Comparado con el ASP, este valor sugiere que los trayectos extremos son poco frecuentes y que la mayor parte de la red se organiza en distancias significativamente menores, con periferias que se conectan al ‘cuerpo’ principal de la red sin quedar completamente aisladas. La figura muestra el par de moteles que definen el diámetro de la componente gigante, ubicados en extremos opuestos del tejido urbano
